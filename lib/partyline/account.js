...
module.exports = {
    ...
    connect: function(user) {
        ...
        let connected = message.highlight(user.name, 'name', 'r') + ' has connected'
        connected = '<div class="pl-chat-message-content col">' + connected + '</div>'
        
        send.all(connected, 'channel-message', user.client)
    }
}